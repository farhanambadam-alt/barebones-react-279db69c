...
export const services: Service[] = [
  // ── Women's Services ──
  { id: 'w1', name: 'Layered Cut & Butterfly Style', duration: '45–60 min', price: 800, originalPrice: 1500, category: 'women', subcategory: 'Hair' },
  { id: 'w2', name: 'Balayage / Global Color', duration: '3–4 hrs', price: 6500, originalPrice: 10000, category: 'women', subcategory: 'Hair' },
  { id: 'w3', name: 'Hair Botox / Keratin Treatment', duration: '2–3 hrs', price: 6000, originalPrice: 12000, category: 'women', subcategory: 'Hair' },
  { id: 'w4', name: 'Korean Glass Skin Ritual', duration: '75 min', price: 1500, originalPrice: 2500, category: 'women', subcategory: 'Skin & Facial' },
  { id: 'w5', name: 'Celebrity Hydrafacial', duration: '60 min', price: 6000, originalPrice: 8000, category: 'women', subcategory: 'Skin & Facial' },
  { id: 'w6', name: 'Classic Lash Extensions', duration: '90–120 min', price: 3000, originalPrice: 5000, category: 'women', subcategory: 'Lashes & Brows' },
  { id: 'w7', name: 'Lash Lift & Tint', duration: '60 min', price: 2000, originalPrice: 3500, category: 'women', subcategory: 'Lashes & Brows' },
  { id: 'w8', name: 'Microblading (Semi-Perm)', duration: '2 hrs', price: 15000, category: 'women', subcategory: 'Lashes & Brows' },
  { id: 'w9', name: 'Professional Bridal Makeup', duration: '3–4 hrs', price: 15000, originalPrice: 40000, category: 'women', subcategory: 'Makeup' },
  { id: 'w10', name: 'Gel Manicure & Nail Art', duration: '60–90 min', price: 1200, originalPrice: 2500, category: 'women', subcategory: 'Nail Care' },
  { id: 'w11', name: 'Signature Spa Pedicure', duration: '60 min', price: 1500, originalPrice: 2200, category: 'women', subcategory: 'Nail Care' },
  { id: 'w12', name: 'Full Body Waxing (Rica)', duration: '90 min', price: 3500, originalPrice: 5000, category: 'women', subcategory: 'Grooming' },
  { id: 'w13', name: 'Aromatherapy Massage', duration: '60–90 min', price: 2500, originalPrice: 4500, category: 'women', subcategory: 'Spa & Wellness' },
  { id: 'w14', name: 'Glutathione IV Drip', duration: '45 min', price: 4000, originalPrice: 6000, category: 'women', subcategory: 'Med-Spa' },
  { id: 'w15', name: 'Pre-Bridal Luxury Package', duration: '2 Days', price: 15000, originalPrice: 35000, category: 'packages', subcategory: 'Packages' },

  // ── Men's Services ──
  { id: 'm1', name: 'Skin Fade / Textured Crop', duration: '30–45 min', price: 400, originalPrice: 800, category: 'men', subcategory: 'Barber' },
  { id: 'm2', name: 'Royal Shave & Beard Design', duration: '30 min', price: 300, originalPrice: 600, category: 'men', subcategory: 'Barber' },
  { id: 'm3', name: 'Scalp Micropigmentation', duration: '2–3 hrs', price: 15000, originalPrice: 30000, category: 'men', subcategory: 'Barber' },
  { id: 'm4', name: 'Scalp Detox / Anti-Dandruff', duration: '45 min', price: 1000, originalPrice: 2000, category: 'men', subcategory: 'Hair' },
  { id: 'm5', name: 'Charcoal Detox Cleanup', duration: '30–45 min', price: 800, originalPrice: 1500, category: 'men', subcategory: 'Skin & Facial' },
  { id: 'm6', name: "Men's Vitamin C Facial", duration: '60 min', price: 2000, originalPrice: 3500, category: 'men', subcategory: 'Skin & Facial' },
  { id: 'm7', name: "Men's Brow Mapping/Shaping", duration: '20 min', price: 300, originalPrice: 600, category: 'men', subcategory: 'Lashes & Brows' },
  { id: 'm8', name: 'Sports Manicure & Grooming', duration: '45 min', price: 800, originalPrice: 1200, category: 'men', subcategory: 'Nail Care' },
  { id: 'm9', name: 'Back & Chest Waxing', duration: '45 min', price: 1500, originalPrice: 2500, category: 'men', subcategory: 'Grooming' },
  { id: 'm10', name: 'Ear & Nose Waxing', duration: '15 min', price: 200, originalPrice: 400, category: 'men', subcategory: 'Grooming' },
  { id: 'm11', name: 'Deep Tissue Sports Massage', duration: '60–90 min', price: 3000, originalPrice: 5000, category: 'men', subcategory: 'Spa & Wellness' },
  { id: 'm12', name: 'Foot Reflexology', duration: '30 min', price: 1200, originalPrice: 1800, category: 'men', subcategory: 'Spa & Wellness' },
  { id: 'm13', name: 'Jawline Definition (Botox)', duration: '30 min', price: 10000, originalPrice: 20000, category: 'men', subcategory: 'Med-Spa' },
  { id: 'm14', name: 'Essential Grooming Combo', duration: '2 hrs', price: 2500, originalPrice: 4000, category: 'packages', subcategory: 'Packages' },
];
