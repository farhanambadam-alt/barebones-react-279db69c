...
import { useSalons, useCategories, useBookings } from '@/services/hooks';
...
const HomePage = () => {
  ...
  const { featuredSalons, nearbySalons } = useSalons();
  const { categories: genderCategories } = useCategories(gender);
    ...
    <div id="main-content" className="min-h-screen pb-safe">
            ...
            [...featuredSalons, ...nearbySalons].slice(0, 3).map((salon) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] font-body text-muted-foreground mt-0.5 truncate">{salon.address} · <DistanceLabel distance={getDistance(salon)} /></p>
      ...
      {completedBookings.length > 0 && (
        <div className="pt-5 pb-3 max-w-7xl mx-auto">
          ...
          <div className="flex gap-3 overflow-x-auto px-5 pb-3 scrollbar-hide" style={{ contain: 'layout style', transform: 'translateZ(0)' }}>
