...
import { useSalons, useCategories } from '@/services/hooks';
...
const ExplorePage = () => {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      blurred = true;
      // Defer blur off the scroll/main thread frame to avoid stutter
      // while the native keyboard animates closed.
      rafId = requestAnimationFrame(() => {
        rafId = null;
        active.blur();
      });
    };
    const onFocusIn = () => { blurred = false; };
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-1.5 mt-2">
                ...
                <DistanceLabel distance={getDistance(salon)} className="text-[13px] font-body text-muted-foreground" />
              </div>
