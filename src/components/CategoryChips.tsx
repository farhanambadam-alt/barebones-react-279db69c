...
const CategoryChips = memo(({ categories, selected, onSelect }: CategoryChipsProps) => {
  return (
    <div className="flex gap-5 overflow-x-auto px-5 py-2 scrollbar-hide" style={{ contain: 'layout style', transform: 'translateZ(0)' }}>
      {categories.map((cat) => {
        ...
        return (
          ...
          >
            ...
            <span className={`font-heading whitespace-nowrap text-sm font-semibold ${
