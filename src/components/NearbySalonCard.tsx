...
const NearbySalonCard = memo(({ salon }: NearbySalonCardProps) => {
  ...
  return (
    <div
      ...
      style={{ contain: 'layout style paint', border: '1px solid hsl(var(--border) / 0.4)', transform: 'translateZ(0)' }}
    >
      ...
      <div className="p-3">
        ...
        <div className="flex items-center gap-1 mt-1.5">
          ...
          <span className="text-[11px] text-muted-foreground">· <DistanceLabel distance={getDistance(salon)} /></span>
        </div>
